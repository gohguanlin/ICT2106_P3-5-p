...
namespace YouthActionDotNet.Control
{
    public class PerformanceEvaluationControl : IUserInterfaceCRUD<PerformanceEvaluation>
    {
        ...
        public async Task<ActionResult<string>> Create(PerformanceEvaluation template)
        {
            ...
            return JsonConvert.SerializeObject(new { success = true, message = "Performance Evaluation Created", data = createdPerformanceEvaluation }, settings);
        }
        ...
        public async Task<ActionResult<string>> Delete(string id)
        {
            ...
            {
                return JsonConvert.SerializeObject(new { success = false, message = "Performance Evaluation Not Found" }, settings);
            }

            await PerformanceEvaluationRepositoryIn.DeleteAsync(performanceevaluation);
            return JsonConvert.SerializeObject(new { success = true, message = "Performance Evaluation Successfully Deleted" }, settings);
        }
        ...
        public async Task<ActionResult<string>> Update(string id, PerformanceEvaluation template)
        {
            ...
            {
                return JsonConvert.SerializeObject(new { success = false, message = "Performance Evaluation ID Mismatch" }, settings);
            }
    ...
    public string getPerformanceEvaluationDetails(string PEF_id)
    {
        return PEF_id;
    }
