...
namespace YouthActionDotNet.Control
{
    public class FeedbackControl : IUserInterfaceCRUD<Feedback>
    {
        ...
        public string Settings()
        {
            ...
            settings.FieldSettings.Add("FeedbackSubject", new InputType { type = "text", displayLabel = "Feedback Subject", editable = false, primaryKey = false });
            ...
            settings.FieldSettings.Add("FeedbackStatus", new InputType { type = "text", displayLabel = "Feedback Status", editable = false, primaryKey = false });
            settings.FieldSettings.Add("FeedbackDateTime", new InputType { type = "text", displayLabel = "Feedback Date Time", editable = false, primaryKey = false });
