...
namespace YouthActionDotNet.Control
{
    public class FeedbackControl : IUserInterfaceCRUD<Feedback>
    {
        ...
        //     try
        //     {
        //         var queryableEvaluations = await FeedbackRepositoryOut.GetAllAsync();
        //         var evaluations = queryableEvaluations.ToList();

        //         var filterSystem = new PerformanceEvaluationFilterSystem();
        //         var filteredEvaluations = filterSystem.filterCriteria(evaluations, filterQuery);

        //         return JsonConvert.SerializeObject(new { success = true, data = filteredEvaluation, message = "Requests Successfully Filtered" }, settings);
        //     }
        //     catch (Exception e)
        //     {
